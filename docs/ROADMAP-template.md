...
> Copy to ROADMAP.md. This file is the canonical "what's next" — AI agents and humans both pull work from here (see AGENTS.md).
...
<!-- Group work into waves/milestones. Pull from the top; don't skip ahead. -->
