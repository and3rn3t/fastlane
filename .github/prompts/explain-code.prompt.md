...
5. **Dependencies**: What does this code depend on and why?
6. **Edge cases**: What special cases does it handle (or miss)?
...
- Include simplified diagrams (mermaid or ASCII) for complex flows
- Highlight potential improvements or concerns

Adjust the depth of explanation based on the complexity of the code. Simple utility functions need brief explanations; complex algorithms need detailed walkthroughs.
